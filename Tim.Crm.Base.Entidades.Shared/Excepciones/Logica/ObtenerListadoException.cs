...
namespace Tim.Crm.Base.Entidades.Excepciones
{
    ...
    /// 
    /// </summary>
    public class ObtenerListadoException : TIMException
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return "Error al intentar hacer una consulta de elementos en CRM.";
        }
        ...
        public ObtenerListadoException(string message,
        ...
        /// <param name="Metodo"></param>
        /// <param name="ArchivoOrigen"></param>
        public ObtenerListadoException(
            string message,
            Exception inner,
            [CallerLineNumber] int NumeroLinea = 0,
            [CallerMemberName] string Metodo = "",
