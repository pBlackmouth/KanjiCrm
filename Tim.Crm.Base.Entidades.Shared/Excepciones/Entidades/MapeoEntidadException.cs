...
namespace Tim.Crm.Base.Entidades.Excepciones
{
    ...
    /// 
    /// </summary>
    public class MapeoEntidadException : TIMException
    {
        ...
        {
            return "Hubo un error en el mapeo de entidades.";
        }
        ...
        public MapeoEntidadException(string message,
