...
namespace Tim.Crm.Base.Entidades.Excepciones
{
    ...
    /// 
    /// </summary>
    public class EstadoEntidadNoDefinidoException : TIMException
    {
        ...
        {
            return "El estado de la entidad no se ha definido.";
        ...
        public EstadoEntidadNoDefinidoException(string message,
        ...
        public EstadoEntidadNoDefinidoException(
            string message,
            Exception inner,
            [CallerLineNumber] int NumeroLinea = 0,
            [CallerMemberName] string Metodo = "",
