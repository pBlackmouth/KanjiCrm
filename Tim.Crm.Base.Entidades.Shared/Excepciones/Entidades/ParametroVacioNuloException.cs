...
namespace Tim.Crm.Base.Entidades.Excepciones
{
    ...
    /// 
    /// </summary>
    public class ParametroVacioNuloException : TIMException
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            return "El parámetro no puede ser vacío o nulo.";
        }
        ...
        public ParametroVacioNuloException(string message,
        ...
        /// <param name="Metodo"></param>
        /// <param name="ArchivoOrigen"></param>
        public ParametroVacioNuloException(
            string message,
            Exception inner,
            [CallerLineNumber] int NumeroLinea = 0,
            [CallerMemberName] string Metodo = "",
