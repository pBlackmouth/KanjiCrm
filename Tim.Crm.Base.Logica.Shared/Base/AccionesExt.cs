...
namespace Tim.Crm.Base.Logica
{
    public class AccionesExt 
    {
        ...
        public AccionesExt(IOrganizationService service)
        {
        ...
        public virtual T ObtenerElemento<T>(EntidadCrm entidad, IOrganizationService service) where T : EntidadCrm
        {
            Entity item = null;
            T itemT = null;
            try
        ...
        public List<T> ObtenerListado<T>(IOrganizationService service) where T : EntidadCrm
        {
            T item = (T)Activator.CreateInstance(typeof(T));
            return ObtenerListado<T>(item, service);
        }
        ...
        public List<T> ObtenerListado<T>(EntidadCrm entidad, IOrganizationService service) where T : EntidadCrm
        {
        ...
        public Respuesta Guardar(EntidadCrm entidad, IOrganizationService service)
        {
        ...
        public Respuesta Eliminar(EntidadCrm entidad, IOrganizationService service)
        {
            Respuesta resp = new Respuesta();
            try
            {
        ...
        /// <returns></returns>
        public Respuesta Asignar(IAsignable asignatario, EntidadCrm entidad, IOrganizationService service)
        {
            Respuesta resp = new Respuesta();
            try
            {
